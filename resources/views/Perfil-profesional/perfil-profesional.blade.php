            ...
            <div class="card-body box-profile text-center">
                ...
                <ul class="list-group list-group-unbordered mb-3 text-left">
                    <li class="list-group-item">
                        <b>Experiencia:</b> <span class="float-right">6 Meses</span>
                    </li>
                    <li class="list-group-item">
...
<div class="card shadow mt-3">
    ...
    <div class="card-body">
        ...
        <div class="mb-3">
            <h5 class="mb-1">Juan Esteban</h5>
            <p class="text-muted">Ingeniero de Software</p>
            <p><i class="fas fa-envelope mr-2"></i> juan.perez@example.com</p>
            <p><i class="fas fa-phone mr-2"></i> +57 300 123 4567</p>
        </div>
        <hr>

        <div class="mb-3">
            <h5 class="mb-1">Alejandra Parra</h5>
            <p class="text-muted">Ingeniero de Software</p>
            <p><i class="fas fa-envelope mr-2"></i> maria.gomez@example.com</p>
            <p><i class="fas fa-phone mr-2"></i> +57 301 987 6543</p>
        </div>
        <hr>

        <div class="mb-3">
            <h5 class="mb-1">Sebastian</h5>
            <p class="text-muted">Ingeniero de Software</p>
            <p><i class="fas fa-envelope mr-2"></i> carlos.rod@example.com</p>
            <p><i class="fas fa-phone mr-2"></i> +57 302 555 8899</p>
        </div>
        <hr>

        <div class="mb-1">
            <h5 class="mb-1">Juan David Brand Sanchez</h5>
            <p class="text-muted">Ingeniero de Software, Lider</p>
            <p><i class="fas fa-envelope mr-2"></i> laura.fernandez@example.com</p>
            <p><i class="fas fa-phone mr-2"></i> +57 304 111 7788</p>
        </div>
    ...
    <div class="col-md-8">
        ...
        <div class="card shadow mt-3">
            ...
            <div class="card-body">
                ...
                <span class="badge badge-primary p-2 mb-1">CSS3</span>
            </div>
        </div>
            ...
            <div class="card-body">
                ...
                <div class="timeline">
                    ...
                    <div>
                        ...
                        <div class="timeline-item">
                            <span class="time"><i class="fas fa-clock"></i> 2025 - Actual</span>
                            <h3 class="timeline-header">Analista de Datos</h3>
                            <div class="timeline-body">
                                Manejo de bases de datos SQL Server, creación de reportes y dashboards.
                            </div>
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="timeline-item">
                            <span class="time"><i class="fas fa-clock"></i> 6 Meses</span>
                            <h3 class="timeline-header">Universidad santiago de cali</h3>
                            <div class="timeline-body">
